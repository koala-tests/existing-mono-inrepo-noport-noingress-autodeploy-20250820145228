# existing-mono-inrepo-noport-noingress-autodeploy-20250820145228
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250820145228:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250820145228:latest
```
